...
public class Executor {
    ...
    private void RunTimeSimulation(int timeFrame, int runtimeSimulationTime) throws CloneNotSupportedException {
        ...
        for (int runTime = timeFrame; runTime <= runtimeSimulationTime; runTime += timeFrame) {
            ...
            // Get Current configuration, environmentCondition --> Monitor
            ...
            //get most similar configuration of the current configuration --> Analysis

            // Retrieve strategyElements retrieve, evolve and set fitness value --> Planning
...
//                    selectedStrategyElement.getStrategyValueList().get(2), selectedStrategyElement.getStrategyValueList().get(3)));
            if (selectedStrategyElement.getStrategyValueList().size() != 0) {
                ...
                ExecuteStrategyAtRunTime(cleaningSoS, selectedStrategy, timeFrame); // --> Execute
            }
...
//
            if(runTime % 100 == 0) {
                ...
                ArrayList<Integer> environmentRet = new ArrayList<>(curEnvironmentCondition.getEnvironmentCondition().values());
...
////                    selectedStrategyElement.getStrategyValueList().get(2), selectedStrategyElement.getStrategyValueList().get(3)));
                ...
                System.out.println(String.format("Current Environment: %d", environmentRet.get(0)));
            }
